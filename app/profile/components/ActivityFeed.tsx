const ActivityFeed = () => {
  ...
  return (
    <div className="w-full rounded-md flex flex-col md:flex-row justify-center gap-4 m-auto border-[0px] p-0 my-20">
            ...
            <div key={index} className="rounded-lg shadow-md p-4 bg-slate-900">
              <p className="text-gray-600 mb-2">
                ...
                {activity.type === 'Collection' && (
                  <span className="text-blue-500 font-bold">Collection:</span>
                )}
                {activity.type === 'Query' && (
